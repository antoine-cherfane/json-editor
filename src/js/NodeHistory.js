    ...
    this.actions = {
      ...
      moveNodes: {
        undo: function (params) {
          ...
          const oldBeforeNode =
            oldParentNode.childs[params.oldIndex] || oldParentNode.append

          // first copy the nodes, then move them
          const nodes = newParentNode.childs.slice(
            params.newIndex,
        ...
        redo: function (params) {
          ...
          const newBeforeNode =
            newParentNode.childs[params.newIndexRedo] || newParentNode.append

          // first copy the nodes, then move them
          const nodes = oldParentNode.childs.slice(
            params.oldIndexRedo,
